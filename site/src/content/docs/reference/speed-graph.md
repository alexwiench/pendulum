---
title: Speed Graph
description: The main visualization in Pendulum — shows velocity across the keyframe span.
---
...
A subtle 4×4 grid provides visual reference. The center lines (50% marks) are slightly brighter to help you gauge symmetry.
